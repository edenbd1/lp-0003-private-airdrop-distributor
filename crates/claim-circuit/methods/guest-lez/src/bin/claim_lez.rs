...
// WHY THIS EXISTS
//
// The one path on LEZ v0.2.4 where a proof is genuinely verified on chain is the
...
// take part in that composition, the claim proof has to *be* a LEZ program: read
// via `read_lee_inputs`, emit a `ProgramOutput`. That is this file.
//
// PRIVACY
//
