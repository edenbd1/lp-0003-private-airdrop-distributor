...
| Basecamp app GUI, downloadable, loadable | ✅ `app/lp-0003-airdrop.lgx` (1.5 MB, `darwin-arm64` + `linux-amd64` variants, so it loads on macOS and Linux), built with the Logos module builder; source + build instructions in `app/`. |
